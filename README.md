...
aws-cli/1.11.100 Python/2.7.9 Linux/4.4.0-78-generic botocore/1.5.63
```
...
```
image:
  name: mlaurie/aws-angular-builder:1.1.1
...
Note you can update the image version `mlaurie/aws-angular-builder:1.1.1` used to the tagged version you require.
