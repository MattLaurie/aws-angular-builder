...
aws-cli/1.11.166 Python/2.7.9 Linux/4.10.0-35-generic botocore/1.7.24
```
...
**Note** from `1.4.3` onwards the version will track the Angular CLI version.  e.g. `mlaurie/aws-angular-builder:1.4.5` will be using Angular CLI 1.4.5.  Let me know if this causes an issue.
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.4.5`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.4.5
...
Note you can update the image version `mlaurie/aws-angular-builder:1.4.5` used to the tagged version you require.
