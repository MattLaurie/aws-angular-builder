...
aws-cli/1.11.83 Python/2.7.9 Linux/4.4.0-75-generic botocore/1.5.46
```
...
```
image:
  name: mlaurie/aws-angular-builder:1.0.26
...
Note you can update the image version `mlaurie/aws-angular-builder:1.0.26` used to the tagged version you require.
