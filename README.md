...
aws-cli/1.11.71 Python/2.7.9 Linux/4.4.0-71-generic botocore/1.5.34
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.0.17`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.0.17
...
Note you can update the image version `mlaurie/aws-angular-builder:1.0.17` used to the tagged version you require.
