...
aws-cli/1.11.118 Python/2.7.9 Linux/4.4.0-83-generic botocore/1.5.81
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.2.3`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.2.3
...
Note you can update the image version `mlaurie/aws-angular-builder:1.2.3` used to the tagged version you require.
