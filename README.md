...
aws-cli/1.11.70 Python/2.7.9 Linux/4.4.0-70-generic botocore/1.5.33
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.0.16`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.0.16
...
Note you can update the image version `mlaurie/aws-angular-builder:1.0.16` used to the tagged version you require.
