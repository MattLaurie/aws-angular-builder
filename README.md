...
aws-cli/1.11.136 Python/2.7.9 Linux/4.4.0-92-generic botocore/1.6.3
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.3.2`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.3.2
...
Note you can update the image version `mlaurie/aws-angular-builder:1.3.2` used to the tagged version you require.
