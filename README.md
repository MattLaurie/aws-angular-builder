...
aws-cli/1.11.79 Python/2.7.9 Linux/4.4.0-72-generic botocore/1.5.42
```
...
```
image:
  name: mlaurie/aws-angular-builder:1.0.23
...
Note you can update the image version `mlaurie/aws-angular-builder:1.0.23` used to the tagged version you require.
