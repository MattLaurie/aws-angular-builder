...
aws-cli/1.11.107 Python/2.7.9 Linux/4.4.0-78-generic botocore/1.5.70
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.1.5`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.1.5
...
Note you can update the image version `mlaurie/aws-angular-builder:1.1.5` used to the tagged version you require.
