...
aws-cli/1.11.67 Python/2.7.9 Linux/4.4.0-66-generic botocore/1.5.30
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.0.14`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.0.14
...
Note you can update the image version `mlaurie/aws-angular-builder:1.0.14` used to the tagged version you require.
