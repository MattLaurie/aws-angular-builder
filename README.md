...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.0.18`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.0.18
...
Note you can update the image version `mlaurie/aws-angular-builder:1.0.18` used to the tagged version you require.
