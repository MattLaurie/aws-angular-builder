...
aws-cli/1.11.150 Python/2.7.9 Linux/4.4.0-93-generic botocore/1.7.8
```
...
It is recommended to use a tagged version (e.g. `mlaurie/aws-angular-builder:1.4.1`) within any continuous build system to 
...
```
image:
  name: mlaurie/aws-angular-builder:1.4.1
...
Note you can update the image version `mlaurie/aws-angular-builder:1.4.1` used to the tagged version you require.
